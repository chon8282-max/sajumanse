        ...
        <Card>
          <CardContent className="p-2">
            <div className="w-full">
              ...
              <div className="grid grid-cols-4 border-t border-l border-r border-border">
                <div 
                  className="border-r border-border px-3 py-0 text-center text-[36px] font-bold text-black leading-none"
                ...
                <div 
                  className="px-3 py-0 text-center text-[36px] font-bold text-black leading-none"
