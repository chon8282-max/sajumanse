...
export default function Compatibility() {
  ...
  return (
    <div className="flex flex-1 min-h-0 h-full w-full flex-col bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
